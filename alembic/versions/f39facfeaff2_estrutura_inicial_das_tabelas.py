...
def company_branch_exchange_coin():
    ...
    `status` ENUM('ENABLED', 'DISABLED') NOT NULL,
    `buy_tourism_vet` DECIMAL(17,5) NOT NULL,
    `sell_tourism_vet` DECIMAL(17,5) NOT NULL,
    `dispatch_international_shipment_vet` DECIMAL(17,5) NOT NULL,
    `receipt_international_shipment_vet` DECIMAL(17,5) NOT NULL,
    `buy_tourism_exchange_fee` DECIMAL(17,5) NOT NULL,
    `sell_tourism_exchange_fee` DECIMAL(17,5) NOT NULL,
    `dispatch_international_shipment_exchange_fee` DECIMAL(17,5) NOT NULL,
    `receipt_international_shipment_exchange_fee` DECIMAL(17,5) NOT NULL,
...
def company_branch_exchange_coin_history():
    ...
    `iof_dispatch_international_shipment_fee` DECIMAL(17,5) NOT NULL,
    `iof_receipt_international_shipment_fee` DECIMAL(17,5) NOT NULL,
    `created_at` DATETIME NOT NULL DEFAULT now(),
    PRIMARY KEY (`id`),
...
def exchange_proposal():
    ...
    `transaction_type` ENUM('BUY', 'SELL', 'SEND', 'RECEIVE') NULL,
    ...
    `name` VARCHAR(150) NOT NULL,
    `responsible name` VARCHAR(150) NULL,
